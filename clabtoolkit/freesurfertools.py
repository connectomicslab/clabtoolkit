...
def parse_freesurfer_statsfile(stat_file: str, format: str = "metric") -> pd.DataFrame:
    ...
    dict_of_cols = {}
    dict_of_cols["brain-brain-intracraneal"] = ""
    dict_of_cols["brain-brain-wholebrain"] = ""
    dict_of_cols["gm-brain-graymatter"] = ""
    dict_of_cols["wm-brain-whitematter"] = ""
    dict_of_cols["vent-lh-lateral"] = ""
    dict_of_cols["vent-lh-inferior"] = ""
    dict_of_cols["vent-rh-lateral"] = ""
    dict_of_cols["vent-rh-inferior"] = ""
    ...
    if os.path.isfile(stat_file):
        ...
        with open(stat_file, 'r') as file:
            for line in file:
                if "EstimatedTotalIntraCranialVol" in line: # Selecting the line with the eTIV
                    eTIV = line.split()[-2].split(',')[0] # Splitting the line and selecting the eTIV value
